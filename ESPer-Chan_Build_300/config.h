...
#define PROJECT_VERSION "Build 300"
...
// 天気予報設定
// ============================================
#define WEATHER_CITY "東京"  // デフォルト地域名（primary_area.xmlのcity名）
...
#define DISPLAY_ST7789_240X320 3   // ST7789 240x320 TFT (SPI)
#define DISPLAY_ST7735S_128X128 4  // ST7735S 128x128 TFT (SPI)

// ★ここで使用するディスプレイを選択
#define DISPLAY_TYPE DISPLAY_SSD1306

// Xiao ESP32S3 Sense GPIO使用マップ:
//   1-3: MAX98357A I2S DAC (使用中)
//   4:   TFT DC
//   5:   SSD1306 SDA ／ TFT CS（表示タイプ毎に排他使用）
//   6:   SSD1306 SCL ／ TFT RST（同上）
//   7:   SD SCK → TFT SCK と SPI2バス共有
//   8:   SD MISO (TFT側は使わない)
//   9:   SD MOSI → TFT MOSI と SPI2バス共有
// ピン定義はディスプレイタイプ別ブロック内に記述
...
#define USE_CUSTOM_FACE 1  // 1: オリジナル顔, 0: デフォルト顔
...
// --- カメラSCCB I2C分離設定（SSD1306と競合回避）---
// SSD1306(M5 Avatar)は I2C_NUM_0 (GPIO5/6) を使用
// カメラSCCBは I2C_NUM_1 (GPIO39/40) を使用
#define CAM_SCCB_I2C_NUM I2C_NUM_1
