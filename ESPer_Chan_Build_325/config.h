...
#define PROJECT_VERSION "Build 325"
...
// 起動時自動再生モード（NVS: "mautop"）
#define MUSIC_AUTO_PLAY_NONE   0  // 何もしない
#define MUSIC_AUTO_PLAY_INDEX  1  // 曲リスト順に再生
#define MUSIC_AUTO_PLAY_RANDOM 2  // ランダムに再生
#define MUSIC_AUTO_PLAY_ARTIST 3  // アーティスト順に再生
#define DEFAULT_MUSIC_AUTO_PLAY MUSIC_AUTO_PLAY_NONE
...
// USER_SERIAL (全ファイル共通)
// ============================================
// USE_USB_CDC=1: ネイティブUSB CDC (USBSerial) + USB.begin() — タクトスイッチあり
// USE_USB_CDC=0: フレームワークのCDC On Boot に任せる (Serial) — タクトスイッチなし・ポート固定
#if USE_USB_CDC
#include "USB.h"
#include "USBCDC.h"
